from texts_to_data import Doc2Data
from texts_to_data import CalculatePair
from mdl import train_model, get_data
...
# postfix can be _sm for demo corpus, _med for other texts, _all for all corpus
postfix = '_sm'
...
# 2 for process pairs
# 3 for train model
# 4 for show confusion matrix and metrics
